# -*- coding: utf-8 -*-
#
# django-viter documentation build configuration file, created by
...
import sys, os, viter, versiontools
...
htmlhelp_basename = 'django-viterdoc'
...
man_pages = [
    ('index', 'django-viter', u'django-viter Documentation',
     [u'Jesús Espino'], 1)
]
